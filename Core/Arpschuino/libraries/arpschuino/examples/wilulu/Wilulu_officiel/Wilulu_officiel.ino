...
fonctionne avec "emeteur_arpschuino_officiel" ou "emeteur_JLink_DMX" ou "arptefact_transceiverOFFICIEL" comme emmeteur
...
20/01/19 : Afin de preserver les accus li-ion, la wilulu se met en veille si la tension d'alimentation descend sous 2.9v

official 01/12/17
Written for the wilulu  www.arpschuino.fr/wilulu_e.php
one channel dimmer
work with "emeteur_arpschuino_officiel" or "emeteur_JLink_bridge_arp" or "arptefact_transceiverOFFICIEL" as emiter
...
float frequency_setting = 868.00; //beetween 866,00 > 870,00
